...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const juegos = [
        new Juego('X en línea', 'Juegos clásicos', '4-en-linea.png', 'juego.html'),
        new Juego('Super Mario Bros', 'Juegos clásicos', 'super-mario-bros.jpg', ''),
        new Juego('Rabbids', 'Juegos populares', 'rabbids.jpg', ''),
        new Juego('Number Blocks', 'Juegos destacados', 'number-blocks.jpg', ''),
    ...
    botonJugar.addEventListener('click', () => {
        if (juegos[indice].titulo === 'X en línea') {
            window.location.href = 'juego.html';
        }
        else if (juegos[indice].titulo === 'Number Blocks'){
            window.location.href = 'promo_number_blocks.html';
        }
    });
});
